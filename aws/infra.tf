...
resource "aws_security_group" "rancher_sg_allowall-yaniv" {
  name        = "${var.prefix}-rancher-allowall-yaniv"
...
resource "aws_instance" "rancher_server" {
  ...
  security_groups = [aws_security_group.rancher_sg_allowall-yaniv.name]
